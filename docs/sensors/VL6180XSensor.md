...
Header: [`src/families/tof/VL6180XSensor.h`](src/families/tof/VL6180XSensor.h)

## Overview

- **Bus:** I2C
- **Sketch aliases:** `TOF050C`, `TOF050F`, `VL6180X`
- **Representative examples:** `VL6180X_BasicRead`, `VL6180X_AmbientRead`
...
| | |
| --- | --- |
| **Parameters** | uint16_t periodMs = 500 |
| **Returns** | `void` |
