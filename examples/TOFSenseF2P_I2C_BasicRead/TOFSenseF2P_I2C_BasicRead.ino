 ...
 *   Sensor    : Serial1 — MCU RX=D0, TX=D1 (cross TX/RX to module), GND common, 3.3 V/5 V per module
 *
 */

#include <DiFinders.h>
#include <Wire.h>
#define MY_TOF_I2C_ADDR DF_ADDR_TOFSENSE

TOFSenseF2P_I2C tofSensor(MY_TOF_I2C_ADDR);

void setup() {
  Serial.begin(115200);
  Wire.begin();
  Wire.setClock(100000);
  Serial.println(F("TOFSenseF2P I2C BasicRead ready"));
  if (!tofSensor.begin()) {
