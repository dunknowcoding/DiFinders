# `SharpAnalogDistanceSensor`

Header: [`src/families/infrared/SharpAnalogDistanceSensor.h`](src/families/infrared/SharpAnalogDistanceSensor.h)

## Overview

- **Bus:** Analog
- **Sketch aliases:** `GP2Y0A02`, `GP2Y0A21`, `GP2Y0A41`, `GP2Y0A51`, `GP2Y0A60`
- **Representative examples:** `GP2Y0A21_BasicRead`, `GP2Y0A21_FilteredRead`
...
SharpAnalogDistanceSensor sensor;
...
| | |
| --- | --- |
| **Parameters** | uint8_t analogPin, SharpAnalogModel model, uint16_t adcReferenceMv = 3300,
                            uint16_t adcMax = DI_FINDERS_DEFAULT_ADC_MAX |
| **Returns** | `` |
...
| | |
| --- | --- |
| **Parameters** | uint16_t adcReferenceMv, uint16_t adcMax |
| **Returns** | `void` |
