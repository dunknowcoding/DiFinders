...
Header: [`src/families/tof/VL53L1XSensor.h`](src/families/tof/VL53L1XSensor.h)

## Overview

- **Bus:** I2C
- **Sketch aliases:** `TOF400C`, `VL53L1CB`, `VL53L1X`
- **Representative examples:** `VL53L1X_BasicRead`, `VL53L1X_DualSensorRead`
...
| --- | --- |
| **Parameters** | None. |
| **Returns** | `DistanceMode` |


### `useShortDistanceMode()`
